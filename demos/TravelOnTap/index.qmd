...
The backbone of this project is the [craft-beers-dataset](https://github.com/nickhould/craft-beers-dataset) by nickhould, scraped from a canned craft beer catalogue circa 2017. It ships as two CSVs that join on `brewery_id`:

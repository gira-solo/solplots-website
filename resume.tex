...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, frame hidden, breakable, enhanced, sharp corners, interior hidden]}{\end{tcolorbox}}\fi
...
```bash quarto render resume.qmd --to pdf

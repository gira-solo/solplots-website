...
3.  Adjust with VIX volatility
4.  Run a Monte Carlo simulation to estimate today's closing price distribution
...
vix      <- readRDS("data/vix_apr1.rds")
params   <- readRDS("data/params_apr1.rds")
mu     <- params$mu
sigma  <- params$sigma
S0     <- params$S0
...
Our greatest edge, i.e. what our model believes to be the most highly mis-priced asset, is ticker `KXINX-26APR01H1600-B6612`. Kalshi believes it has a 40% chance of resolving to YES, whereas our model believes it has a 5.2% chance of resolving to YES. That is nearly a 35% difference!
